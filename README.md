# MODEL1310110019: MODEL1310110019
...
`pip install git+https://github.com/biomodels/MODEL1310110019.git`

To install a specific version (in this example, from the 2014-09-16 BioModels release)

`pip install git+https://github.com/biomodels/MODEL1310110019.git@20140916`

## Usage

Importing the model package.

`import MODEL1310110019 as model`
...
The model of vagina squamous epithelial cells metabolism is derived from the
...
and identified by:
[MODEL1310110019](http://identifiers.org/biomodels.db/MODEL1310110019) .
